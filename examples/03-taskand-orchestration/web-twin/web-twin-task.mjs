...
const root = process.env.TASKAND_ROOT || '/home/tom/github/paxlet-com/taskand';
const args = process.argv.slice(2), target = args[0] || 'github';
const specPath = ['github', 'subactor'].includes(target) ? join(here, `web-twin-${target}.json`) : target;
