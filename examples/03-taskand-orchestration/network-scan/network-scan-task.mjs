...
const root = process.env.TASKAND_ROOT || (existsSync('/home/tom/github/paxlet-com/taskand') ? '/home/tom/github/paxlet-com/taskand' : fileURLToPath(new URL('..', import.meta.url)));
